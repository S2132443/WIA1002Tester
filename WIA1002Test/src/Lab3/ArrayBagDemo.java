...
public class ArrayBagDemo {
    ...
    public static void main(String[] args) {
        /*
        Create 2 empty ArrayBag bjects of the type array for
        ...
        */
        ...
        /*
        Then filling an initially empty bag, bag1 and bag2 with
        a list of strings using the method testAdd.
        Display the contents of bag1 and bag2 using the method displayBag
        */
        ...
        */
        ...
        creates a new bag of objects that would be left in bag1
        after removing the objects that occur in bag2
